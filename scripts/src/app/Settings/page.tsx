    ...
    <div>
      ...
      >
        ...
        <div className="mt-[80px] px-[2vw] py-8">
          ...
          {/* Profile Section */}
          <section className="mb-10 p-6 border border-neutral-200 dark:border-neutral-700 rounded-lg shadow-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      id="username"
                      type="text"
                      className="border border-neutral-300 dark:border-neutral-600 px-3 dark:bg-neutral-800 bg-neutral-50 py-2 text-[16px] rounded-md w-full text-neutral-500 dark:text-neutral-400 cursor-not-allowed"
                      value={
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="border border-neutral-300 dark:border-neutral-600 px-3 dark:bg-neutral-900 bg-white py-2 text-[16px] rounded-md w-full focus:ring-indigo-500 focus:border-indigo-500 dark:focus:ring-indigo-400 dark:focus:border-indigo-400"
