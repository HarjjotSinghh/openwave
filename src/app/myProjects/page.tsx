            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex gap-2">
                <Button asChild size="sm" className="flex-1">
                  <Link href={`/myProjects/Issues?repo=${repo?.project_repository}`}>View Project</Link>
                </Button>
      ...
      </div>
      {
        repoData.length === 0 && (
          <div className="text-center py-10">
                            ...
                            <h3 className="mt-2 text-lg font-medium text-neutral-900 dark:text-white">No projects found</h3>
