        ...
        <div className="flex">
          ...
          >
            ...
            <div className="mt-20 mx-4">
              <div>
                <h1 className="pt-3 dark:text-transparent dark:bg-clip-text dark:bg-gradient-to-r from-white to-neutral-500 text-3xl font-bold">
                  Projects in your favorite languages{" "}
                </h1>
                <p className="pt-2 dark:text-neutral-400 text-[15px]">
                ...
                <div className="mt-4 flex mx-4">
                  <input
                    ...
                    className="px-2 w-full border border-neutral-600 rounded bg-[#191919] text-white placeholder-neutral-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
                    value={searchTerm}
                  ...
                  <div className="mt-4 mx-4 w-1/3">
                    ...
                    <select
                      ...
                      className="p-2 w-full border border-neutral-600 rounded bg-[#191919] text-white focus:outline-none focus:ring-1 focus:ring-blue-500"
                    >
