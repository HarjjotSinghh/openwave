                              ...
                              ([lang, percentage]: [string, number]) => {
                                ...
                                return (
                                  ...
                                  >
                                    ...
                                    <div
                                      className={`overAVAX-hidden text-sm rounded-full font-medium dark:text-white text-custom-neutral`}
                                    >
                                      <span
                                ...
                                <div className="flex flex-col gap-2">
                                  <div className="flex flex-col sm:flex-row sm:justify-between gap-2 text-sm">
                                    ...
                                    <div className="text-center sm:text-right flex">
                                      <img src="/AVAX_small.png" alt="AVAX Logo" width={24} height={24} className="mr-2" />
