...
const id = (session?.data?.user as SessionUser)?.username;
    ...
    return (
        ...
        <div className="flex items-center justify-center min-h-screen">
            <div className="max-w-[900px] w-[40rem] p-6 rounded-lg shadow-md border-2 border-neutral-600">
        ...
        <div className="flex items-center justify-center min-h-screen">
            <div className="max-w-[900px] w-[40rem] p-6 rounded-lg shadow-md border-2 border-neutral-600">
                ...
                <form className="space-y-4" onSubmit={handleSignUp}>
                    <div>
                        <label htmlFor="metaMask" className="block text-sm font-medium text-neutral-200">
                            MetaMask Address
                        </label>
                        <input
                            ...
                            name="metaMask"
                            required
                            className="mt-1 block w-full px-3 py-2 border border-neutral-500 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
