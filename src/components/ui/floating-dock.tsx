  ...
  return (
    <div className={cn("relative block md:hidden", className)}>
            ...
            {items.map((item, idx) => (
              ...
              >
                <a
                  href={item.href}
                  key={item.title}
                  className="flex h-10 w-10 items-center justify-center rounded-full bg-neutral-50 dark:bg-neutral-900"
                >
      ...
      <button
        ...
        className="flex h-10 w-10 items-center justify-center rounded-full bg-neutral-50 dark:bg-neutral-800"
      >
