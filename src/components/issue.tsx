        ...
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-2">
            ...
            <span className="flex items-center gap-1 text-neutral-300">
              Open
              <span className="bg-neutral-700 text-neutral-300 px-2 py-0.5 rounded-full text-xs ml-1">1</span>
            </span>
          </div>
          
          <span className="flex items-center gap-1 text-neutral-400">
            Closed
            <span className="bg-neutral-700 text-neutral-400 px-2 py-0.5 rounded-full text-xs ml-1">0</span>
          </span>
        </div>
